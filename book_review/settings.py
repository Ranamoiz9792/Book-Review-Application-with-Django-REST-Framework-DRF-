...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),  # Or any other valid path
# ]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ranamoiz9792@gmail.com'  # Replace with your actual email
EMAIL_HOST_PASSWORD = 'kliq synb kaqh nnan'  # Replace with generated App Password
